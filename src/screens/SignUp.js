...
const SignUp = () => {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor:"#e7abed"}}>
            <Image source={require('../images/Image2.jpeg')} style={{ width: 100, height: 100, alignSelf: "center", borderRadius: 50, marginTop: 10 }} />
            ...
            <CustomButton bgColor={buttonDisabled ? '#236328' : 'black'} title={"Sign up"} style={{ width: "50%" }} textColor={"#fff"} onPress={() => signUp()}disabled={buttonDisabled}/>
